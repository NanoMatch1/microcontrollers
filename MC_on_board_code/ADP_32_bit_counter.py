...
#                 print('Reading from register {}'.format(register))
                self.total_counts = 0
                register.value(0)
                self.trigger_read()
                register.value(1)
                ...
                print("Read register {}:{}".format(register, self.total_counts))
...
# 
            ...
            print('else loop, sending UART of no action: received command {}'.format(command))
